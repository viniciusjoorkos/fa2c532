...
import { ArrowRight, CheckCircle2, Loader2, Mail, Lock, Users, Sparkles } from "lucide-react";
...
export default function ThankYouPremium() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Set plan to premium immediately
      if (data.user) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-black text-white antialiased">
      {/* Subtle ambient glow — premium gold/white */}
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(40%_30%_at_50%_100%,rgba(212,175,55,0.06),transparent_70%)]" />
        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="text-center">
            <h1 className="font-serif text-[32px] font-light leading-[1.1] tracking-tight text-white sm:text-4xl">
              Parabéns,{" "}
              <span className="italic text-amber-300/90">bem‑vindo.</span>
            </h1>
            <p className="mx-auto mt-3 max-w-xs text-[13px] leading-relaxed text-white/45">
              Acabamos de confirmar seu cadastro no plano <strong className="font-medium text-white/70">Premium</strong>. Crie seu acesso abaixo para entrar na plataforma.
            </p>
          </div>
          ...
          {done ? (
            <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.03] p-7 text-center backdrop-blur-xl">
              ...
              <p className="mt-2 text-[13px] text-white/45">
                ...
                <br />Após confirmar, seu acesso Premium estará ativo.
              </p>
            ...
            >
              <div className="flex flex-col gap-4">
                {/* Email */}
                <div>
                  <label htmlFor="th-email" className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.28em] text-white/40">
                ...
                {/* Password */}
                <div>
                  <label htmlFor="th-pwd" className="flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[0.28em] text-white/40">
          ...
          <p className="mt-6 text-center font-mono text-[9px] uppercase tracking-[0.32em] text-white/20">
            RZ Trader Studio · Plano Premium
          </p>
        </div>
      </main>
    </div>
